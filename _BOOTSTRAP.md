...
Criar template de repositório AI-friendly que Wesley possa `cp -R` em qualquer projeto novo. Tudo neutro/genérico (sem stack específica) com placeholders `node-ts`, `marketing-engine`, etc.
...
- [ ] Placeholders consistentes: `marketing-engine`, `node-ts`, `<TEAM>`, `<DOMAIN>`
...
Stack neutra com placeholders node-ts/marketing-engine/<TEAM>/<DOMAIN>.
